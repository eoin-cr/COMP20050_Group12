...
public class ElkTests {
    ...
    public void testElk1Vertical() {
        ...
        assertEquals(ScoringElk.scoreElk(map, "E1"), 10);
    }
...
//        Display.displayTileMap(map);
    ...
    public void testElk2() {
        ...
        map.clearTileBoard();
        map.addTileToMap(newElkTile(), 8,8);
        assertEquals(ScoringElk.scoreElk(map, "E2"), 2);
        map.addTileToMap(newElkTile(), 8,9);
        assertEquals(ScoringElk.scoreElk(map, "E2"), 4);
        map.addTileToMap(newElkTile(), 8,10);
        assertEquals(ScoringElk.scoreElk(map, "E2"), 7);
        map.addTileToMap(newElkTile(), 7,8);
        assertEquals(ScoringElk.scoreElk(map, "E2"), 10);
        map.addTileToMap(newElkTile(), 9,8);
        assertEquals(ScoringElk.scoreElk(map, "E2"), 14);
        map.addTileToMap(newElkTile(), 9,9);
        assertEquals(ScoringElk.scoreElk(map, "E2"), 18);
        map.addTileToMap(newElkTile(), 10,7);
        assertEquals(ScoringElk.scoreElk(map, "E2"), 23);
        map.addTileToMap(newElkTile(), 12,7);
        assertEquals(ScoringElk.scoreElk(map, "E2"), 25);
        map.addTileToMap(newElkTile(), 8,7);
        assertEquals(ScoringElk.scoreElk(map, "E2"), 30);
...
//        map.addTileToMap(newElkTile(), 9,9);
//        Display.displayTileMap(map);
//        assertEquals(ScoringElk.scoreElk(map, "E2"), 6);

        PlayerMap secondMap = new PlayerMap();
        secondMap.clearTileBoard();
        secondMap.addTileToMap(newElkTile(), 8,8);
        assertEquals(ScoringElk.scoreElk(secondMap, "E2"), 2);
        secondMap.addTileToMap(newElkTile(), 8,10);
        assertEquals(ScoringElk.scoreElk(secondMap, "E2"), 4);
        secondMap.addTileToMap(newElkTile(), 9,9);
        assertEquals(ScoringElk.scoreElk(secondMap, "E2"), 6);
        secondMap.addTileToMap(newElkTile(), 9,11);
        assertEquals(ScoringElk.scoreElk(secondMap, "E2"), 8);
        secondMap.addTileToMap(newElkTile(), 9,10);
        assertEquals(ScoringElk.scoreElk(secondMap, "E2"), 14);
    }
    ...
    public void testElk3Basics() {
        ...
        map.clearTileBoard();
        map.addTileToMap(newElkTile(), 8, 8);
        assertEquals(ScoringElk.scoreElk(map, "E3"), 2);
        map.addTileToMap(newElkTile(), 8,9);
        assertEquals(ScoringElk.scoreElk(map, "E3"), 5);
        map.addTileToMap(newElkTile(), 7,9);
        assertEquals(ScoringElk.scoreElk(map, "E3"), 9);
        map.addTileToMap(newElkTile(), 9,9);
        assertEquals(ScoringElk.scoreElk(map, "E3"), 13);
    }
}
